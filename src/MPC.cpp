...
public:
  ...
  void operator()(ADvector &fg, const ADvector &vars)
  {
    ...
    * Recall fg[0] is reserved for the cost value, so
    * the other indices are bumped up by 1.
    */
    ...
    /*  Add fg[0] stores the cost value, so there's always an offset of 1. 
    * So fg[1 + psi_start] is where we store the initial value of ψ. 
    * Finally, fg[1 + psi_start + t] is reserved for the tth of 
    * N values of ψ that the solver computes.
    */
    for (int t = 1; t < N; t++)
    {
